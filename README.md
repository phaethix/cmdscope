<p align="center">
  <picture>
    ...
    <img alt="cmdscope turns a raw agent command into a staged impact preview: stage 1 npm run clean with a conditional delete of build/** from package.json, stage 2 npm run build with a blocking dynamic_path unknown — without executing anything." src="assets/hero-light.svg" width="880">
  </picture>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/phaethix/cmdscope/actions/workflows/ci.yml"><img src="https://github.com/phaethix/cmdscope/actions/workflows/ci.yml/badge.svg" alt="CI" /></a>
...
A reviewer usually can't tell from the raw string what these will affect. cmdscope answers the questions that matter before execution:
...
<p align="center">
  <picture>
    ...
    <img alt="cmdscope analysis pipeline: parse, expand, extract, prove, report — deterministic rules only, no execution, no network, no LLM guessing." src="assets/flow-light.svg" width="880">
  </picture>
</p>
