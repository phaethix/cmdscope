...
var allowedInternalImports = map[string][]string{
	...
	modulePath + "/internal/adapter/codex":  {modulePath + "/internal/adapter/shared"},
	modulePath + "/internal/adapter/claude": {modulePath + "/internal/adapter/shared"},
	modulePath + "/internal/adapter/shared": {modulePath + "/internal/analyzer", modulePath + "/internal/facts", modulePath + "/internal/ir"},
