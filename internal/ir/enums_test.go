...
func TestEnumValuesUniqueWithinType(t *testing.T) {
	cases := []struct {
		...
		{"UnknownCode", []string{
			...
			string(ir.UnknownEffectsRuntimeDependent),
		}},
		{"Flag", []string{
...
func TestEnumConstantExactValues(t *testing.T) {
	exact := map[string]string{
		...
		"UnknownEffectsRuntimeDependent": string(ir.UnknownEffectsRuntimeDependent),
	...
	want := map[string]string{
		...
		"UnknownCwdRuntimeDependent":     "cwd_runtime_dependent",
		"UnknownTildeRuntimeDependent":   "tilde_runtime_dependent",
		"UnknownEffectsRuntimeDependent": "effects_runtime_dependent",
